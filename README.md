...
| **`currentMtu`**                                            | <code>number</code>  | Sets the current MTU value. This method should be used only if the device is already connected and MTU has been requested before DFU service is started.                                                                                                                                                                                                                                                                                       | <code>23</code>    | 1.0.0 |
